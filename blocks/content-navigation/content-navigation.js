...
//       document.getElementById('navdropdownMenuButton').textContent = document.
...
export default function decorate(block) {
  ...
  // const generealTabSelector = div.querySelectorAll('p');
  // const generalTabValues = Array.from(generealTabSelector).map((p) => p.textContent);
  // const [contentnavigationLabel, background, isEnabled] = generalTabValues;

  // const BtnTabSelector = div.querySelectorAll('p[class]');
  // const buttonTabValues = Array.from(BtnTabSelector).map((p) => {
  ...
  // const [{ text: btnLable, link: btnLink }] = buttonTabValues;
